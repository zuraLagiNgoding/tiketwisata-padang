      ...
      <div className='flex flex-col bg-white rounded-lg gap-6 shadow-lg'>
        <div className='flex h-[75vh]'>
          <div 
            ...
            style={{ backgroundImage: `url(${destinationDetail[0].image})`}}
          >
          </div>
          <div className='flex flex-col basis-2/3 p-6 2xl:p-9 gap-3 relative overflow-x-hidden'>
            <div className='basis-5/12 flex flex-col gap-2 overflow-hidden'>
              <div className='flex items-center justify-between pr-4'>
                <div>
                  <h1 className='text-xl 2xl:text-3xl font-semibold'>{destinationDetail[0].name}</h1>
              ...
              <p className='text-xs 2xl:text-base overflow-y-auto'>{destinationDetail[0].about}</p>
            </div>
